...
insert into ttrss_prefs (pref_name,type_id,def_value,short_desc,section_id) values('DISABLE_HEADLINE_POPUPS', 1, 'false', 'Disable popup previews on mouseover in the headline list' ,2);
